...
router.post('/sendotp', function (req, res, next) {
    ...
    if (pattern.test(number)) {
        axios.get('https://2factor.in/API/V1/13fcccf8-d864-11e9-ade6-0200cd936042/SMS/' + number + '/AUTOGEN')
            .then(response => {
...
router.post('/verifyotp', function (req, res, next) {
    ...
    if (sessionId && otp && phone) {
        axios.get(`https://2factor.in/API/V1/13fcccf8-d864-11e9-ade6-0200cd936042/SMS/VERIFY/${sessionId}/${otp}`)
            .then(response => {
                console.log(response.data);
